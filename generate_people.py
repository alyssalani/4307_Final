...
genres=('Metal', 'Rock', 'Rap', 'Country', 'EDM', 'Indie', 'Alternative', 'Raggae', 'Pop', 'Classical', 'Instrumental', 'Jazz', 'R&B', 'Folk', 'Speeches', 'Audio-Books', 'Opera', 'Latin', 'Christain', 'K-Pop', 'Lo-Fi', 'Punk', 'Disco')
